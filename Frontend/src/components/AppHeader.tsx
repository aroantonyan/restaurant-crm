...
/**
 * Top safe area: Telegram's Bot_CRM bar lives OUTSIDE the WebView, so the
 * WebView starts at y=0. We just want a small breathing margin (`pt-3` = 12px)
 * — not the 52px the prototype used to simulate a phone status bar.
 *
...
export default function AppHeader({ title, subtitle, onBack, trailing, large = true }: Props) {
  return (
    <div className="bg-bg pt-3 px-5 pb-3 flex flex-col gap-1.5">
